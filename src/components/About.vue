<template>
    <body class="page-about">
        ...
        <section class="about">
            <div class="about-me">
                Я создатель этого сайта. Этот сайт был создан в качестве итогового проекта. Надеюсь Вам было интересно его изучить
            </div>
            <div class="partners">
                Мои партнёры: 
                <ul>
                    <li style="color: yellow;">Яндекс.Недвижимость</li>
                    <li style="color: yellow;">Яндекс.Афиша</li>
                    <li style="color: yellow;">Яндекс.Еда</li>
                </ul>
            </div>
            <div class="mail">
                Связаться со мной можно по почте:
                <a href="email.html" class="link">Почта</a>
            </div>
        </section>
    </body>
</template>
